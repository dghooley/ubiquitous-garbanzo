        ...
        <div id="experience" className="experience">
            ...
            <div className="container experience-wrapper">
                ...
                <div className="timeline-block timeline-block-right">
                    ...
                    <div className="timeline-content">
                        <h3>2018-2020</h3>
                        <p>IVY TECH COMMUNITY COLLEGE | SUPPLEMENTAL INSTRUCTOR : Assisted students through coursework as necessary via walk-ins, email or text. Areas of focus in included Computer Information Systems and Visual Communications</p>
                    </div>
                </div>{/* - */}
                <div className="timeline-block timeline-block-left">
                    <div className="marker"></div>
